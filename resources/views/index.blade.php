...
<div class="nav col-xs-12 col-md-12 col-lg-12 col-sm-12">
	...
	<div class="search-div col-md-12 col-sm-12 col-xs-12  col-lg-12">
		...
		<div align="center" class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
			<div class="radio-search" name="a"><input type="radio">&nbsp;&nbsp;Book&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="radio-search" name="a"><input type="radio">&nbsp;&nbsp;Author&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
			<div class="radio-search" name="a"><input type="radio">&nbsp;&nbsp;Publication</div>
		</div>
	</div>
	{{--End Search Div--}}
	<br><br>
