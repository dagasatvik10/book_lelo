...
<?php $__env->startSection('content'); ?>
	<?php /*<nav class="col-md-12 col-md-12 col-sm-12 col-xs-12">*/ ?>
		<?php /*<center><div class="circular"></div></center>*/ ?>
...
<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 top-holder" style="width:100%; margin-left:0; padding-bottom: 10px;">
	...
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
		<?php /*<form action="<?php echo e(url('/search')); ?>" method="post">*/ ?>
			<?php /*<?php echo csrf_field(); ?>*/ ?>
		<?php /*<div class="col-md-11 col-xs-11 col-lg-11 col-sm-11"><input type="text" name="search" class="search-bar" placeholder="Search Books, Authors and Publication Here!"/></div>*/ ?>
		<?php /*<div class="col-md-1 col-xs-1 col-lg-1 col-sm-1"><i class="fa fa-search search-icon"></i> </div>*/ ?>
		<?php /*<br>*/ ?>
		<?php /*</form>*/ ?>
